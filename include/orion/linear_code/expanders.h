...
#include "orion/linear_code/parameter.h"
...
public:
    ...
    ::std::vector<::std::vector<common::prime_field::field_element>> weight;
    ::std::vector<::std::vector<common::prime_field::field_element>> r_weight;
    long long L, R;
};
...
inline graph generate_random_expander(long long L, long long R, long long d)
{
    ...
    for(long long i = 0; i < L; ++i)
    {
        ...
        for(long long j = 0; j < d; ++j)
        {
            ...
            common::prime_field::field_element weight = common::prime_field::random();
