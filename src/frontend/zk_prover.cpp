...
// void frontend::zk_prover::generate_maskpoly_pre_rho(int length, int degree)
// {
// 	if(maskpoly != NULL) 
// 		delete[] maskpoly;
...
// void frontend::zk_prover::generate_maskpoly_after_rho(int length, int degree)
// {
// 	for(int i = 0; i < length * degree + 1 + 6; i++){
...
// void frontend::zk_prover::generate_maskR(int layer_id){
// //	vpdR::KeyGen(2);
...
// }
/*
std::pair<std::vector<bn::Ec1>, std::vector<bn::Ec1> > frontend::zk_prover::prove_R(std::vector<mpz_class> R, mpz_class &ans)
{
	std::chrono::high_resolution_clock::time_point t0 = std::chrono::high_resolution_clock::now();
...
std::pair<std::vector<bn::Ec1>, std::vector<bn::Ec1> > frontend::zk_prover::prove_mask(std::vector<mpz_class> R, mpz_class &ans)
{
	std::chrono::high_resolution_clock::time_point t0 = std::chrono::high_resolution_clock::now();
	std::vector<bn::Ec1> witness, witnessa;
...
bool gate_meet[14];
void frontend::zk_prover::init_array(int max_bit_length)
{
...
frontend::zk_prover::~zk_prover()
{
}



void frontend::zk_prover::sumcheck_phase1_init()
{
	std::chrono::high_resolution_clock::time_point t0 = std::chrono::high_resolution_clock::now();
	//mult init
...
{	
	...
	common::quintuple_poly ret5(ret.d, ret.e, ret.f, ret.a, ret.b, ret.c);
	std::chrono::high_resolution_clock::time_point t1 = std::chrono::high_resolution_clock::now();
...
void frontend::zk_prover::proof_init()
{
	//todo
}
