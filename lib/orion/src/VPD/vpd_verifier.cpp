#include "lib/orion/include/linear_gkr/verifier.h"
#include "lib/orion/include/infrastructure/RS_polynomial.h"
#include "lib/orion/include/infrastructure/utility.h"
#include "lib/orion/include/linear_gkr/prover.h"
#include "lib/orion/include/poly_commitment/poly_commit.h"
#include <iostream>
#include <cstdio>

namespace orion {

bool verify_merkle(__hhash_digest h, ::std::vector<__hhash_digest> merkle_path, int len, int pow, ::std::vector<::std::pair<prime_field::field_element, prime_field::field_element> > value)
{
...
poly_commit::ldt_commitment poly_commit::poly_commit_prover::commit_phase(int log_length)
{
	...
	printf("[Orion] FRI commit time %lf\n", time_span.count());
